...
func (Config_ValueType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_header_to_metadata_e025ca8e93fbd1fd, []int{0, 0}
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return fileDescriptor_header_to_metadata_e025ca8e93fbd1fd, []int{0}
}
...
func (*Config_Rule) Descriptor() ([]byte, []int) {
	return fileDescriptor_header_to_metadata_e025ca8e93fbd1fd, []int{0, 1}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/header_to_metadata/v2/header_to_metadata.proto", fileDescriptor_header_to_metadata_e025ca8e93fbd1fd)
}

var fileDescriptor_header_to_metadata_e025ca8e93fbd1fd = []byte{
